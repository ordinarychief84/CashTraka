  ...
  async sendTrialStarted(args: {
    ...
    const body = `
      <div style="text-align:center;margin-bottom:24px;">
        ...
        <p style="margin:0;font-size:14px;color:#475569;">30 days of full access, no payment required.</p>
      </div>
    ...
    return send({
      ...
      html: layout(body, { preheader: `30-day free trial of ${args.plan}. Expires ${endsOn}.` }),
    });
  },
