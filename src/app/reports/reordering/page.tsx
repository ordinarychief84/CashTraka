      ...
      <div className="flex flex-col md:flex-row md:min-h-[calc(100vh-8rem)] md:gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="mb-5 flex items-center justify-between">
            <h1 className="text-xl font-bold text-ink">Reordering</h1>
            <button
              type="button"
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="Search"
                    className="w-full rounded-md border border-slate-300 px-2.5 py-1.5 text-[13px] placeholder:text-slate-400 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100"
                  />
                </div>
              ...
              {/* Supplier column */}
              <div className="space-y-4">
                <h2 className="text-[13px] font-semibold text-ink">Supplier</h2>

                <div>
                  <label className="mb-1 block text-[12px] font-medium text-slate-600">Supplier</label>
                  <div className="flex items-center gap-1">
                    <select className="min-w-0 flex-1 rounded-md border border-slate-300 px-2.5 py-1.5 text-[13px] text-slate-500 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100">
