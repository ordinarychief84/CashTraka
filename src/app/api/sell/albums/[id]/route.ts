...
/** GET /api/sell/albums/[id] — fetch the album with its products. */
...
/** PATCH /api/sell/albums/[id] — update meta fields. */
...
/** DELETE /api/sell/albums/[id] — remove an album (cascades to AlbumProduct). */
