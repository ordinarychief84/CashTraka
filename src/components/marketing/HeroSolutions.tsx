          ...
          <div>
            ...
            <Reveal from="up" delay={260}>
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link href="/signup" className="group relative inline-flex items-center gap-2 rounded-full bg-ink px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-ink/20 transition hover:-translate-y-0.5 hover:shadow-xl">
                ...
                <a href="#solutions" className="group inline-flex items-center gap-2 rounded-full border border-border bg-white px-5 py-3.5 text-sm font-semibold text-slate-800 transition hover:border-brand-400 hover:text-brand-700">
...
function BackgroundDecor() {
  return (
    <>
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 opacity-[0.35]" style={{ backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(15, 23, 42, 0.08) 1px, transparent 0)', backgroundSize: '24px 24px', maskImage: 'radial-gradient(ellipse 70% 80% at 50% 30%, black 40%, transparent 80%)', WebkitMaskImage: 'radial-gradient(ellipse 70% 80% at 50% 30%, black 40%, transparent 80%)' }} />
      <div aria-hidden className="pointer-events-none absolute -top-24 -left-24 -z-10 h-[28rem] w-[28rem] rounded-full bg-brand-300/30 blur-[120px]" />
      <div aria-hidden className="pointer-events-none absolute -bottom-32 right-0 -z-10 h-[28rem] w-[28rem] rounded-full bg-success-300/25 blur-[120px]" />
    </>
  );
}
...
function HeroVisual() {
  return (
    <div className="relative mx-auto w-full max-w-[30rem] md:max-w-none md:pl-6">
      <div className="relative rounded-2xl border border-slate-200 bg-white/95 p-5 shadow-xl shadow-slate-900/5 backdrop-blur" style={{ animation: 'float 7s ease-in-out infinite' }}>
        <div className="flex items-center justify-between">
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-wider text-slate-500">Received today</div>
            <div className="mt-1 text-3xl font-black tabular-nums text-ink">₦142,500</div>
          </div>
        ...
        <svg viewBox="0 0 200 40" className="mt-3 h-10 w-full" preserveAspectRatio="none" aria-hidden>
          <defs>
          ...
          <path d="M0 30 L20 26 L40 28 L60 22 L80 24 L100 18 L120 20 L140 12 L160 15 L180 8 L200 10 L200 40 L0 40 Z" fill="url(#sparkFill)" />
          <path d="M0 30 L20 26 L40 28 L60 22 L80 24 L100 18 L120 20 L140 12 L160 15 L180 8 L200 10" fill="none" stroke="#00B8E8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      ...
      <div className="absolute -right-4 top-[36%] w-[19rem] rounded-2xl border border-success-200 bg-white p-4 shadow-2xl shadow-success-500/10 md:-right-6" style={{ animation: 'float 8s ease-in-out infinite 0.7s' }}>
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-[10px] font-bold uppercase tracking-wide text-success-700">Payment verified</div>
            <div className="mt-0.5 text-sm font-bold text-ink">GTBank credit · ₦45,000</div>
            <div className="mt-0.5 text-[11px] text-slate-500">From <span className="font-semibold text-ink">AMAKA NWOSU</span> · ref 9843</div>
          </div>
        </div>
      ...
      <div className="relative mt-4 ml-auto w-[18rem] rounded-2xl border border-slate-200 bg-white p-4 shadow-2xl shadow-slate-900/10 md:-mt-2 md:ml-[-2rem]" style={{ animation: 'float 9s ease-in-out infinite 1.4s' }}>
        <div className="flex items-center gap-2">
          ...
          <span className="ml-auto rounded-full bg-owed-50 px-2 py-0.5 text-[9px] font-bold text-owed-700">Overdue</span>
        </div>
        <div className="mt-3 rounded-lg border border-slate-100 bg-slate-50/80 p-2.5 text-[11px] leading-relaxed text-slate-700">
          Hi Chidi 👋 Just a quick reminder about the ₦7,500 balance on your order. Let me know when it's sent.
        </div>
        <button className="mt-2 flex w-full items-center justify-center gap-1.5 rounded-lg bg-[#25D366] py-2 text-[11px] font-bold text-white shadow-sm" disabled>
