          ...
          <div className="rounded-xl border border-slate-200 bg-white p-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="mb-1 block text-[12px] font-medium text-slate-600">Item from</label>
                ...
                <div>
                  <label className="mb-1 block text-[12px] font-medium text-slate-600">Item to</label>
                  <div className="flex items-center gap-1">
                    <input
                      type="text"
                      className="min-w-0 flex-1 rounded-md border border-slate-300 px-2.5 py-1.5 text-[13px] placeholder:text-slate-400 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100"
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="mb-1 block text-[12px] font-medium text-slate-600">Item group from</label>
                  <div className="flex items-center gap-1">
                    <input
                      type="text"
                      className="min-w-0 flex-1 rounded-md border border-slate-300 px-2.5 py-1.5 text-[13px] placeholder:text-slate-400 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100"
                ...
                <div>
                  <label className="mb-1 block text-[12px] font-medium text-slate-600">Item group to</label>
                  <div className="flex items-center gap-1">
                    <input
                      type="text"
                      className="min-w-0 flex-1 rounded-md border border-slate-300 px-2.5 py-1.5 text-[13px] placeholder:text-slate-400 focus:border-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-100"
